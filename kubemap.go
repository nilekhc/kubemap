...
//Mapper accepts collection different k8s resources.
//They will be mapped to respective common label returned to user
// func Mapper(resources KubeResources) (MappedResources, error) {
